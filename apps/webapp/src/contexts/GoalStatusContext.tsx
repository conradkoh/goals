...
const _GoalStatusContext = createContext<GoalStatusContextType | undefined>(
  undefined
);
 ...
 */
export const GoalStatusProvider: React.FC<GoalStatusProviderProps> = ({
  children,
}) => {
  ...
  const _setPendingStatusMutation = useMutation(
    api.pendingGoals.setPendingStatus
  );
  const _clearPendingStatusMutation = useMutation(
    api.pendingGoals.clearPendingStatus
  );
  ...
  return (
    <_GoalStatusContext.Provider value={value}>
      {children}
    </_GoalStatusContext.Provider>
  );
};
